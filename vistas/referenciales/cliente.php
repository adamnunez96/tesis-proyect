              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Clientes <button id="btnagregar" class="btn btn-success" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class="panel-body table-responsive"  id="formularioregistros">
                        <form name="formulario" id="formulario" action="" method="post">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="nombre" id="nombre" onblur="mayuscula(this)" maxlength="50" placeholder="Nombre del Cliente" required>
                          </div>
...
<?php
  ...
  require 'footer.php';
?>
<script src="../scripts/referenciales/cliente.js"></script>
