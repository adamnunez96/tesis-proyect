                  ...
                  <ul class="treeview-menu">
                    ...
                    <li class="treeview">
                      ...
                      <ul class="treeview-menu">
                        ...
                        <li><a href="ciudad.php"><i class="fa fa-circle-o"></i> Ciudades</a></li>
                        <li><a href="deposito.php"><i class="fa fa-circle-o"></i> Depositos</a></li>
                        <li><a href="tipoDocumento.php"><i class="fa fa-circle-o"></i> Tipo Documentos</a></li>
                      </ul>
                    </li>
                    <li class="treeview">
                      <a href="#"><span>Compras</span><i class="fa fa-angle-left pull-right"></i></a>
                      <ul class="treeview-menu">
                        <li><a href="mercaderia.php"><i class="fa fa-circle-o"></i> Mercaderias</a></li>
                        <li><a href="marca.php"><i class="fa fa-circle-o"></i> Marcas</a></li>
                        <li><a href="proveedor.php"><i class="fa fa-circle-o"></i> Proveedores</a></li>
                        <li><a href="tipoImpuesto.php"><i class="fa fa-circle-o"></i> Tipo de Impuestos</a></li>
                      </ul>
                    </li>
                    <li class="treeview">
                      <a href="#"><span>Ventas</span><i class="fa fa-angle-left pull-right"></i></a>
                      <ul class="treeview-menu">
                        <li><a href="tarjeta.php"><i class="fa fa-circle-o"></i> Tarjetas</a></li>
                        <li><a href="formaPago.php"><i class="fa fa-circle-o"></i> Formas de Pago</a></li>
                        <li><a href="entidadEmisora.php"><i class="fa fa-circle-o"></i> Entidades Emisoras</a></li>
                        <li><a href="caja.php"><i class="fa fa-circle-o"></i> Cajas</a></li>
                        <li><a href="marcaTarjeta.php"><i class="fa fa-circle-o"></i> Marcas Tarjetas</a></li>
                      </ul>
                    </li>
                    <li class="treeview">
                      <a href="#"><span>Servicios</span><i class="fa fa-angle-left pull-right"></i></a>
                      <ul class="treeview-menu">
                        <li><a href="vehiculo.php"><i class="fa fa-circle-o"></i> Vehiculos</a></li>
                        <li><a href="cliente.php"><i class="fa fa-circle-o"></i> Clientes</a></li>
                        <li><a href="personal.php"><i class="fa fa-circle-o"></i> Personales</a></li>
                      </ul>
                    </li>
              ...
              <?php 
                if($_SESSION['VENTAS']==1){
                  echo '<li class="treeview">
                    ...
                    <ul class="treeview-menu">
                    <li><a href="../ventas/aperturaCierreCaja.php"><i class="fa fa-circle-o"></i> Apertura/Cierre Caja</a></li>
                    <li><a href="../ventas/facturaVenta.php"><i class="fa fa-circle-o"></i> Facturas Venta</a></li>
                    <li><a href="../ventas/cobro.php"><i class="fa fa-circle-o"></i> Cobros</a></li>
                    <li><a href="../ventas/notaCreditoDebito.php"><i class="fa fa-circle-o"></i> Nota Credito/Debito</a></li>
                    <li><a href="../ventas/arqueo.php"><i class="fa fa-circle-o"></i> Arqueo</a></li>
                    <li><a href="../ventas/recaudaciones.php"><i class="fa fa-circle-o"></i> Recaudaciones a Depositar</a></li>
                    <li><a href="../ventas/libroVenta.php"><i class="fa fa-circle-o"></i> Libro Ventas</a></li>                
                    </ul>
                  </li>';
                }
              ?>  
