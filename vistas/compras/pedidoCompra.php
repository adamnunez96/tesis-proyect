              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Pedidos Compra <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i>Nuevo</button></h1>
...
<?php
  ...
  require 'footer.php';
?>
<script src="../scripts/compras/pedidoCompra.js"></script>
