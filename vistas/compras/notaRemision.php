              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Nota Remision <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i>Nuevo</button></h1>
                    ...
                    <div class="panel-body table-responsive"  id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Envia(*):</label>
                            <select name="idperEnvia" id="idperEnvia" class="form-control selectpicker" data-live-search="true" required>
                            </select>
                          </div>
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <select name="iddeposito" id="iddeposito" class="form-control selectpicker" data-live-search="true" required>
                            </select>
                          </div>
...
<?php
  ...
  require 'footer.php';
?>
<script src="../scripts/compras/notaRemision.js"></script>
