...
function listar(){
    tabla=$('#tbllistado').dataTable({
        ...
        "ajax":
                {
                    url: '../../ajax/servicios/servicio.php?op=listar',
                    type: "get",
                    dataType: "json",
                    error: function(e){
...
function listarVehiculos(){
    ...
    tabla=$('#tblvehiculos').dataTable({
        ...
        "ajax":
                {
                    url: '../../ajax/servicios/servicio.php?op=listarVehiculos',
                    type: "get",
                    dataType: "json",
                    error: function(e){
                        console.log(e.responseText);
...
function listarOrdenesTrabajo(){
    ...
    tabla=$('#tblOrdenes').dataTable({
        ...
        "ajax":
                {
                    url: '../../ajax/servicios/servicio.php?op=listarOrdenesTrabajo',
                    type: "get",
                    dataType: "json",
                    error: function(e){
                        console.log(e.responseText);
...
function listarMercaderias(){
    ...
    tabla=$('#tblmercaderias').dataTable({
        ...
        "ajax":
                {
                    url: '../../ajax/servicios/servicio.php?op=listarMercaderias',
                    type: "get",
                    dataType: "json",
                    error: function(e){
                        console.log(e.responseText);
...
function guardaryeditar(e){
    ...
    $.ajax({
        url: "../../ajax/servicios/servicio.php?op=guardaryeditar",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
function mostrar(idservicio){
    ...
    $.post("../../ajax/servicios/servicio.php?op=mostrar",{idservicio : idservicio}, function(data, status){
        //console.log(data);
        data = JSON.parse(data);
        mostrarform(true);

        $("#idorden").val(data.idordentrabajo);
    ...
    $.post("../../ajax/servicios/servicio.php/?op=listarDetalleVehiculo&id="+idservicio, function(r){
        $("#detalles").html(r);
    });
    $.post("../../ajax/servicios/servicio.php/?op=listarDetalleManoObra&id="+idservicio, function(r){
...
function agregarOrden(idorden){
    $.post("../../ajax/servicios/servicio.php?op=listarCabeceraOrdenTrabajo",{idorden : idorden}, function(data, status){
        data = JSON.parse(data);
        //console.log(data);
        mostrarform(true);
        $("#idorden").val(data.idordentrabajo);
    ...
    $.post("../../ajax/servicios/servicio.php/?op=listarDetalleOrdenTrabajo&id="+idorden, function(res){
        let data = JSON.parse(res);
        mostrarDetalle(data);
    });
    $.post("../../ajax/servicios/servicio.php/?op=listarDetalleOrdenTrabajo2&id="+idorden, function(res){
