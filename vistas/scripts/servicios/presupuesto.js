...
function init(){
    ...
    $.post("../../ajax/servicios/presupuesto.php?op=selectCliente", function(r){
        $("#idcliente").html(r);
...
function mostrarform(flag){
    ...
    if (flag) {
        ...
        $("#btnAgregarDiagnostico").show();
        $("#btnMercaderia").show();
    }else{
        $("#listadoregistros").show();
        $("#formularioregistros").hide();
        $("#btnagregar").show();
        $("#btnAgregarDiagnostico").hide();
    }
}
...
function listar(){
    tabla=$('#tbllistado').dataTable({
        ...
        "ajax":
                {
                    url: '../../ajax/servicios/presupuesto.php?op=listar',
                    type: "get",
                    dataType: "json",
                    error: function(e){
...
function listarVehiculos(){
    ...
    tabla=$('#tblvehiculos').dataTable({
        ...
        "ajax":
                {
                    url: '../../ajax/servicios/presupuesto.php?op=listarVehiculos',
                    type: "get",
                    dataType: "json",
                    error: function(e){
                        console.log(e.responseText);
...
function listarDiagnosticos(){
    ...
    tabla=$('#tblDiagnosticos').dataTable({
        "aProcessing": true, //ativamos el procesamiento del datatables
        "aServerSide": true, //paginacion y filtrado realizados por el servidor
        dom: 'Bfrtip',//definimos los elementos del control de tabla
        buttons: [
        ...
        "ajax":
                {
                    url: '../../ajax/servicios/presupuesto.php?op=listarDiagnosticos',
                    type: "get",
                    dataType: "json",
                    error: function(e){
                        console.log(e.responseText);
...
function listarMercaderias(){
    ...
    tabla=$('#tblmercaderias').dataTable({
        ...
        "ajax":
                {
                    url: '../../ajax/servicios/presupuesto.php?op=listarMercaderias',
                    type: "get",
                    dataType: "json",
                    error: function(e){
                        console.log(e.responseText);
...
function guardaryeditar(e){
    ...
    $.ajax({
        url: "../../ajax/servicios/presupuesto.php?op=guardaryeditar",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
function mostrar(idpresupuesto){
    ...
    $.post("../../ajax/servicios/presupuesto.php?op=mostrar",{idpresupuesto : idpresupuesto}, function(data, status){
        //console.log(data);
    ...
    $.post("../../ajax/servicios/presupuesto.php/?op=listarDetalleVehiculo&id="+idpresupuesto, function(r){
        $("#detalles").html(r);
    });
    $.post("../../ajax/servicios/presupuesto.php/?op=listarDetalleManoObra&id="+idpresupuesto, function(r){
        $("#detallesMercaderia").html(r);
    });

}

function agregarDiagnostico(iddiagnostico){

    $.post("../../ajax/servicios/presupuesto.php?op=listarCabeceraDiagnostico",{iddiagnostico : iddiagnostico}, function(data, status){
        data = JSON.parse(data);
        mostrarform(true);
    ...
    $.post("../../ajax/servicios/presupuesto.php/?op=listarDetalleDiagnostico&id="+iddiagnostico, function(res){
