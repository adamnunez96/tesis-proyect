              ...
              <?php 
                if($_SESSION['SERVICIOS']==1){
                  echo '<li class="treeview">
                          ...
                          <ul class="treeview-menu">
                            <li><a href="recepcion.php"><i class="fa fa-circle-o"></i> Recepcion Motocicleta</a></li>
                            <li><a href="diagnostico.php"><i class="fa fa-circle-o"></i> Diagnostico Motocicleta</a></li>
                            <li><a href="presupuesto.php"><i class="fa fa-circle-o"></i> Presupuesto Servicio</a></li>
                            <li><a href="ordenTrabajo.php"><i class="fa fa-circle-o"></i> Orden de Trabajo</a></li>
