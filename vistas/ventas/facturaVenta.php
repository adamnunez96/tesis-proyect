              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Facturas Venta <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> 
                          
                          
                          Nuevo</button><a data-toggle="modal" href="#myModal2">
                              <button id="btnAgregarServicio" type="button" class="btn btn-primary"><span class="fa fa-plus"></span>
                              Agregar Servicio
                              </button>
                            </a></h1>
                    ...
                    <div class="panel-body table-responsive"  id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-2 col-md-2 col-sm-4 col-xs-12">
                            ...
                            <input type="text" name="idservicio" id="idservicio" class="form-control" readonly>
                          </div>
                          ...
                          <div class="form-group col-lg-3 col-md-3 col-sm-4 col-xs-12">
                            <label>Fecha(*):</label>    
                            <input type="datetime" class="form-control" name="fecha_hora" id="fecha_hora" required="">
                          </div>

                          <div class="form-group col-lg-6 col-md-6 col-sm-8 col-xs-12">
                            <label>Nro de Factura(*):</label>
                            <input type="text" class="form-control" name="nrofactura" id="nrofactura" placeholder="Numero de Factura" required readonly>
                          </div>

                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Timbrado(*):</label>
                            <input type="text" class="form-control" name="idtimbrado" id="idtimbrado" required readonly>
                            <!--span id="idtimbrado" class="form-control"></span-->
                          </div>
                          ...
                          <!--este especio es para el calculo de los ivas-->
                            ...
                            <div class="form-group col-lg-2 col-md-2 col-sm-4 col-xs-12 ivas">
                                <label>TOTAL: </label><h4 id="total" class="form-control borde text-center">Gs/.0.00</h4><input type="hidden" name="total_venta" id="total_venta">
                            </div>
...
<?php
  ...
  require 'footer.php';
?>
<script src="../scripts/ventas/facturaVenta.js"></script>
