...
//Intanciasmos la clase para generar el documento pdf
...
//Seteamos el tipo de letra y creamos el articulo de la pagina. No es un encabezado no se repetira
...
require_once "../modelos/referenciales/Mercaderia.php.php";
$articulo = new Mercaderia();
